...
class TobitOptimizationTest(unittest.TestCase):
    ...
    def test_uncensored(self):
        ...
        loss = censored_mae_with_truncation_penalty(y_pred = y_pred, y = y, clamp_all = True)
    ...
    def test_lower_censored_1(self):
        ...
        loss = censored_mae_with_truncation_penalty(y_pred = y_pred, y = y, lower_censoring_bound = low_censor, clamp_all = True)
        self.assertTrue(t.allclose(loss, expected_loss))
    ...
    def test_upper_censored_1(self):
        ...
        loss = censored_mae_with_truncation_penalty(y_pred = y_pred, y = y, upper_censoring_bound = upper_censor, clamp_all = True)
        self.assertTrue(t.allclose(loss, expected_loss))
    ...
    def test_combined_1(self):
        ...
        expected_loss = t.tensor((0 + .1 + .2 + .2 + .1 + 0)/6)
        loss = censored_mae_with_truncation_penalty(y_pred = y_pred, y = y, lower_censoring_bound = lower_censor, upper_censoring_bound = upper_censor, clamp_all = True)
        self.assertTrue(t.allclose(loss, expected_loss))
    ...
    def test_truncated_1(self):
        ...
        loss = censored_mae_with_truncation_penalty(y_pred=y_pred, y=y, lower_truncation_limit = lower_truncation, clamp_all = True)
        self.assertTrue(t.allclose(loss, expected_loss))
    ...
    def test_truncated_3(self):
        ...
        loss = censored_mae_with_truncation_penalty(y_pred=y_pred, y=y, upper_truncation_limit = upper_truncation, clamp_all = True)
        self.assertTrue(t.allclose(loss, expected_loss))
    ...
    def test_combined_2(self):
        ...
        expected_loss = t.tensor((.1 + .1 + .2 + .4 + .1 + .1)/6)
