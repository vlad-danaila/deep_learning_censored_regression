...
from experiments.synthetic.heteroscedastic.tobit_based.reparam_fixed_std.reparametrized_tobit_loss_synthetic_heter_data import \
...
from experiments.synthetic.heteroscedastic.tobit_based.reparam_fixed_std.reparametrized_gll_synthetic_heter_data import plot_gll_reparam
...
def plot_composed_synthetic_cn_reparam_tobit_fixed_std():
    ...
    plt.show()
    save_figures('experiments/all_img/synt_het_reparam_tobit_fixed_std')
