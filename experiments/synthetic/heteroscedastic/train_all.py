...
# from experiments.synthetic.heteroscedastic.tobit_based.scaled_fixed_std.scaled_gll_synthetic_data import tpe_opt_gll_scaled
# from experiments.synthetic.heteroscedastic.tobit_based.scaled_fixed_std.scaled_tobit_loss_synthetic_data import tpe_opt_deep_NO_trunc, tpe_opt_deep_WITH_trunc, \
#     tpe_opt_lin_NO_trunc, tpe_opt_lin_WITH_trunc
# from experiments.synthetic.heteroscedastic.tobit_based.reparam_fixed_std.reparametrized_gll_synthetic_data import tpe_opt_gll_reparam
# from experiments.synthetic.heteroscedastic.tobit_based.reparam_fixed_std.reparametrized_tobit_loss_synthetic_data import tpe_opt_deep_NO_trunc_reparam, \
...
# MAE Based
print('-' * 20, 'eval_mae_simple', '-' * 20)
eval_mae_simple()
print('-' * 20, 'eval_mae_cens_NO_trunc', '-' * 20)
eval_mae_cens_NO_trunc()
print('-' * 20, 'eval_mae_cens_WITH_trunc', '-' * 20)
eval_mae_cens_WITH_trunc()

# MSE Based
print('-' * 20, 'eval_mse_simple', '-' * 20)
eval_mse_simple()
print('-' * 20, 'eval_mse_cens_NO_trunc', '-' * 20)
eval_mse_cens_NO_trunc()
print('-' * 20, 'eval_mse_cens_WITH_trunc', '-' * 20)
