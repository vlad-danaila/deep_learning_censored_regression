...
from experiments.synthetic.heteroscedastic.mae_based.mae_based_synthetic_heter import plot_mae_simple, plot_mae_cens_NO_trunc, plot_mae_cens_WITH_trunc
from experiments.synthetic.heteroscedastic.mse_based.mse_based_synthetic_heter import plot_mse_simple, plot_mse_cens_NO_trunc, plot_mse_cens_WITH_trunc
...
def plot_composed_synthetic_cn_mae_mse():
    ...
    plt.show()
    save_figures('experiments/all_img/synt_het_mae_mse')
