...
from experiments.real.bike_sharing.tobit_based.reparam_fixed_std.reparametrized_tobit_bike import \
...
from experiments.real.bike_sharing.tobit_based.reparam_fixed_std.reparam_gll_bike import plot_gll_reparam
...
def plot_composed_pm25_tobit_fixed_std():
    ...
    plt.show()
    save_figures('experiments/all_img/bike_reparam_tobit_fixed_std')
