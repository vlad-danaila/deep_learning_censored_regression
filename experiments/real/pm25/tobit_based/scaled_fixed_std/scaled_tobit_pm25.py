...
"""Constants"""
ROOT_DEEP_TOBIT_SCALED = f'experiments/real/pm25/tobit_based/scaled_fixed_std/deep_tobit_cens_NO_trunc/{REAL_EXPERIMENTS_PREFIX}'
CHECKPOINT_DEEP_TOBIT_SCALED = 'scaled deep tobit model'

ROOT_DEEP_TOBIT_SCALED_TRUNCATED = f'experiments/real/pm25/tobit_based/scaled_fixed_std/deep_tobit_cens_WITH_trunc/{REAL_EXPERIMENTS_PREFIX}'
CHECKPOINT_DEEP_TOBIT_SCALED_TRUNCATED = 'scaled truncated deep tobit model'

ROOT_LINEAR_TOBIT_SCALED = f'experiments/real/pm25/tobit_based/scaled_fixed_std/liniar_tobit_cens_NO_trunc/{REAL_EXPERIMENTS_PREFIX}'
CHECKPOINT_LINEAR_TOBIT_SCALED = 'scaled linear tobit model'

ROOT_LINEAR_TRUNCATED_TOBIT_SCALED = f'experiments/real/pm25/tobit_based/scaled_fixed_std/liniar_tobit_cens_WITH_trunc/{REAL_EXPERIMENTS_PREFIX}'
